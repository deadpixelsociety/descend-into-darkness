...
func _update_resource_value():
	...
	if resource_value > 0.0:
		var resource_width = size.x - (VIAL_BORDER_WIDTH * 2.0)
		var resource_max_height = size.y - (VIAL_BORDER_WIDTH * 2.0)
		var resource_height = resource_max_height * resource_value
